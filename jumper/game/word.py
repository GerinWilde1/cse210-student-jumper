...
"""We need the logic to know how many spaces are needed for whichever word is chosen.
As well as the logic to show the letter if they make a correct choice.
Good idea: keep all the universal variables in the '__init__' function, or just all the variables really."""
...
class Word:
        ...
        def __init__(self):
            ...
            self.words = random.choice("abruptly", "absurd", "abyss", "affix", "askew", "avenue", "awkward", "axiom",
